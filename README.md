...
<head>
    ...
    <title>Sweet Start - Premium Cakes and Brownies</title>
    <link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@400;600&display=swap" rel="stylesheet">
    <style>
        /* General Body & Layout Styles (from main.html) */
        body {
        ...
        /* Navigation Styles (from main.html) */
        nav {
        ...
        /* Banner/Hero Section (from main.html) */
        .banner {
